...
namespace AutoTelemetryWorker.Processor
{
    public class TelemetryProcessor
    {
        ...
        {
            _logger.LogInformation("Iniciando validación del chasis {ChasisId}. TransactionId: {TransactionId}",Environment.CurrentManagedThreadId ,evento.ChasisId, evento.Id);
